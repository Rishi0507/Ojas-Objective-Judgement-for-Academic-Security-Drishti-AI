                    ...
                    <div key={i} className="flex gap-4 p-3 rounded-lg border border-border bg-background">
                      {off.snapshot ? (
                        <button
                          ...
                          className="flex-shrink-0 w-32 h-[72px] rounded-md overflow-hidden border border-border hover:ring-2 hover:ring-primary transition-all"
                        ...
                        <div className="flex-shrink-0 w-32 h-[72px] rounded-md border border-dashed border-border flex items-center justify-center text-[10px] text-muted-foreground text-center px-2">
                          No still captured
                        </div>
                      )}
